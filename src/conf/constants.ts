...
export const basicModelName = "Basic";
export const basicReversedModelName = "Basic (and reversed card)";
export const basicOptionalReversedModelName = "Basic (optional reversed card)";
export const basicTypingModelName = "Basic (type in the answer)";
export const clozeModelName = "Cloze";
export const noteFormLanguage = "note-form";
